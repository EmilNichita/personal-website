...
function FeelingProud(props) {
  ...
  return (
    ...
    >
      ...
      <g id="head">
        ...
        <g id="chin">
          <path
            id="path45"
            d="M 73.8 115.3 c 0 -24.9 20.2 6.3 45.1 6.3 s 45.1 -31.2 45.1 -6.3 s -16 45.7 -45.1 45.1 S 73.8 140.2 73.8 115.3 z"
            fill={theme.skinColor}
          />
        </g>
        <g id="face">
      ...
      <g id="legs">
        ...
        <g id="notebook">
          ...
          <g id="banana" transform="scale(0.08)" transform-origin="110 230">
            <path
              fill="#FFB95C"
              d="M442.985,346.293l-8.159,10.709l5.246,18.501c0,0-103.14,59.243-222.487-82.423
	...
	C314.18,286.875,395.41,329.402,442.985,346.293z"
            ...
            <path
              fill="#FCAD2D"
              d="M249.42,17.273c9.202-3.525,20.082-5.813,31.789-4.517l14.062,22.798
	...
	c0,0-103.14,59.243-222.487-82.423c0,0-91.722-125.633-7.763-243.969C219.824,35.016,233.277,23.452,249.42,17.273z"
            ...
            <polygon
              fill="#965B2F"
              points="442.985,346.293 449.871,351.539 447.904,369.985 440.072,375.503 434.827,357.002 "
            />
            <path
              fill="#FFB95C"
              d="M403.482,441.015l-12.005,10.624l1.85,22.827c0,0-134.177,45.352-240.836-147.728
	...
	C266.761,341.825,351.818,410.282,403.482,441.015z"
            ...
            <path
              fill="#FCAD2D"
              d="M253.45,11.92c11.561-1.989,24.803-2.148,38.172,2.077l11.156,29.884
	...
	c0,0-134.177,45.352-240.836-147.728c0,0-78.094-167.962,47.338-286.781C214.773,25.804,233.167,15.41,253.45,11.92z"
            ...
            <polygon
              fill="#965B2F"
              points="403.482,441.015 410.312,448.733 403.75,469.826 393.33,474.466 391.477,451.639 "
            />
            <path
              fill="#FFB95C"
              d="M283.065,481.39l-15.041,7.216l-4.646,23.371c0,0-147.186,7.18-198.941-216.402
	...
	C174.495,343.199,240.114,435.928,283.065,481.39z"
            ...
            <path
              fill="#FCAD2D"
              d="M255.106,9.28c12.138,1.299,25.432,4.915,37.608,12.948l1.74,21.667
	...
	c0,0-147.186,7.18-198.941-216.402c0,0-30.321-190.316,129.029-273.503C212.45,12.16,233.815,6.995,255.106,9.28z"
            ...
            <polygon
              fill="#965B2F"
              points="283.065,481.39 287.705,491.056 275.133,510.302 263.381,511.974 268.028,488.603 "
            />
            <polygon
              fill="#A9B135"
            ...
            <polygon
              fill="#BEC142"
              points="294.457,43.891 348.318,22.976 356.088,36.306 301.903,63.124 295.371,55.306 "
            />
          </g>
          <path
